...
void add_handler_to_idt(int idx, u32 handler);
void load_idt();
...
void build_and_load_idt() {
    ...
    add_handler_to_idt(0, (u32) isr0);
    add_handler_to_idt(1, (u32) isr1);
    add_handler_to_idt(2, (u32) isr2);
    add_handler_to_idt(3, (u32) isr3);
    add_handler_to_idt(4, (u32) isr4);
    add_handler_to_idt(5, (u32) isr5);
    add_handler_to_idt(6, (u32) isr6);
    add_handler_to_idt(7, (u32) isr7);
    add_handler_to_idt(8, (u32) isr8);
    add_handler_to_idt(9, (u32) isr9);
    add_handler_to_idt(10, (u32) isr10);
    add_handler_to_idt(11, (u32) isr11);
    add_handler_to_idt(12, (u32) isr12);
    add_handler_to_idt(13, (u32) isr13);
    add_handler_to_idt(14, (u32) isr14);
    add_handler_to_idt(15, (u32) isr15);
    add_handler_to_idt(16, (u32) isr16);
    add_handler_to_idt(17, (u32) isr17);
    add_handler_to_idt(18, (u32) isr18);
    add_handler_to_idt(19, (u32) isr19);
    add_handler_to_idt(20, (u32) isr20);
    add_handler_to_idt(21, (u32) isr21);
    add_handler_to_idt(22, (u32) isr22);
    add_handler_to_idt(23, (u32) isr23);
    add_handler_to_idt(24, (u32) isr24);
    add_handler_to_idt(25, (u32) isr25);
    add_handler_to_idt(26, (u32) isr26);
    add_handler_to_idt(27, (u32) isr27);
    add_handler_to_idt(28, (u32) isr28);
    add_handler_to_idt(29, (u32) isr29);
    add_handler_to_idt(30, (u32) isr30);
    add_handler_to_idt(31, (u32) isr31);
   ...
   port_write_byte(0xA1, 0x0);
    ...
    add_handler_to_idt(32, (u32) irq0);
    add_handler_to_idt(33, (u32) irq1);
    add_handler_to_idt(34, (u32) irq2);
    add_handler_to_idt(35, (u32) irq3);
    add_handler_to_idt(36, (u32) irq4);
    add_handler_to_idt(37, (u32) irq5);
    add_handler_to_idt(38, (u32) irq6);
    add_handler_to_idt(39, (u32) irq7);
    add_handler_to_idt(40, (u32) irq8);
    add_handler_to_idt(41, (u32) irq9);
    add_handler_to_idt(42, (u32) irq10);
    add_handler_to_idt(43, (u32) irq11);
    add_handler_to_idt(44, (u32) irq12);
    add_handler_to_idt(45, (u32) irq13);
    add_handler_to_idt(46, (u32) irq14);
    add_handler_to_idt(47, (u32) irq15);
